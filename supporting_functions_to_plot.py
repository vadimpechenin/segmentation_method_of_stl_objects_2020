"""Функция для поддержки рисования stl в plot_segmentation_objects.py"""
...
def plot_stl_faces_segmentation_paint(struct_seg1, num_segments1, surface_seg1,
    ...
    if noize is None:
        ...
        struct_seg = copy.deepcopy(struct_seg1)
    ...
    # работа с палитрой
    lab = parula(7)# struct_seg
    for num in range(0, struct_seg):
        mesh = trimesh.Trimesh(vertices=vertices,
